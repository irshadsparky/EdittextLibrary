package com.irshad.edittextlib;
...
import com.irshad.edittextlib.R;

public class CustomEditTextwithError extends EditText {
    ...
    public CustomEditTextwithError(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CustomEditTextwithError(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CustomEditTextwithError);

        if (a.hasValue(R.styleable.CustomEditTextwithError_ErrorDefaultIcon)) {
            mErrorIcon = a.getDrawable(R.styleable.CustomEditTextwithError_ErrorDefaultIcon);
        }
        if (mErrorIcon == null) {
        }
        if (a.hasValue(R.styleable.CustomEditTextwithError_ErrorDefaultBackground)) {
            mErrorBackground = a.getDrawable(R.styleable.CustomEditTextwithError_ErrorDefaultBackground);
        }
        if (mErrorBackground == null) {
        }
        if (a.hasValue(R.styleable.CustomEditTextwithError_ErrorDefaultBackgroundAbove)) {
            mErrorBackgroundAbove = a.getDrawable(R.styleable.CustomEditTextwithError_ErrorDefaultBackgroundAbove);
        }
        if (mErrorBackgroundAbove == null) {
        }
        if (a.hasValue(R.styleable.CustomEditTextwithError_ErrorTextColor)) {
            mErrorTextColor = a.getColor(R.styleable.CustomEditTextwithError_ErrorTextColor, Color.rgb(50, 50, 50));
        }
    }
